...
item_spawn.append(DrinkSpawns, item_spawn.zoned_drink_spawn(5, 3, 66.3, "monster", 20, 80, 66, 80))
item_spawn.append(DrinkSpawns, item_spawn.zoned_drink_spawn(10, 10, 81.0, "icecoffee", 0, 0, 60, 60, 30))

WeaponSpawns = {
	{ x = 400, y = 400, delay = 0.0, type = "straight", ammoBonus = 0 },
	{ x = 230, y = 331, delay = 39.0, type = "uzi", ammoBonus = 68 },
	{ x = 680, y = 591, delay = 87.0, type = "rocket", ammoBonus = 10 },
}
